...
def chrome_options(chrome_options, pytestconfig):
    ...
    chrome80 = ('Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) '
                'AppleWebKit/537.36 (KHTML, like Gecko) '
                'Chrome/80.0.3987.100 Safari/537.36')
    chrome_options.add_argument(f'--user-agent="{chrome80}"')
...
def firefox_options(firefox_options, pytestconfig):
    ...
    firefox68 = ('Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:72.0) '
