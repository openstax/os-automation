...
def test_about_tutor_learn_more(web_base_url, selenium):
    ...
    # THEN: User should be auto scrolled to the
    # How does OpenStax Tutor Beta work section.
    # AND: Footer should be visible where user should see
    # the options to get started or join a webinar section.
...
def test_view_faq_questions(web_base_url, selenium):
    ...
    # AND: When clicked on the link user should be redirected
    # to the OpenStax Tutor force.com page.
