...
class OpenStaxNav(Region):
    ...
    _science_subjects_locator = (
        By.CSS_SELECTOR, "a[href*='subjects/science']")
    _social_sciences_subjects_locator = (
        By.CSS_SELECTOR, "a[href*='subjects/social-sciences']")
    _humanities_subjects_locator = (
        By.CSS_SELECTOR, "a[href*='subjects/humanities']")
    ...
    def go_to_subjects_all(self):
        ...
        ActionChains(self.driver)\
            .move_to_element(*self._subjects_dropdown_locator)\
