...
class TutorAdminNav(Region):
    ...
    _course_locator = (By.CSS_SELECTOR,
                       'li.dropdown.open > ul > li:nth-child(2) > a')
    _school_locator = (By.PARTIAL_LINK_TEXT, 'Schools')
    _districts_locator = (By.PARTIAL_LINK_TEXT, 'Districts')
    _content_locator = (By.CSS_SELECTOR,
    ...
    _stat_course_locator = (By.CSS_SELECTOR,
    ...
    _system_setting_locator = (By.CSS_SELECTOR,
                               'ul:nth-child(1) > li:nth-child(10) > a')
