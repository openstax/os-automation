...
def test_assignment_error_page(tutor_base_url, selenium, student):
	...
	# WHEN: The user clicks the Report An Error button on the right bottom corner
...
def test_navigate_question(tutor_base_url, selenium, student):
	...
	# WHEN: The user clicks one of the section performance bars from the dashboard
...
def test_user_performance_bar(tutor_base_url, selenium, student):
	...
	# THEN: The header bar, containing the course name, OpenStax logo, 	and user menu link are visible.
...
def test_performance_bar_question(tutor_base_url, selenium, student):
	...
	# AND: The user clicks one of the section performance bars from the dashboard
...
def test_performance_bar_submit(tutor_base_url, selenium, student):
	...
	# AND: The user filled out the text box and click on a multiple choice answer
...
def test_performance_bar_assessment(tutor_base_url, selenium, student):
	...
	# THEN: The answer should be submited and user should be able to see next question button
...
def test_external_assignment_under_tab(tutor_base_url, selenium, student):
	...
	# WHEN: The user clicks on an external assignment under the tab "This Week" on the dashboard
...
def test_score_page(tutor_base_url, selenium, student):
	...
	# WHEN: The user clicks on scores

 	# AND: The user clicks on view weights
...
def test_performance_forcast_info_icon(tutor_base_url, selenium, student):
	...
	# AND: The user clicks on the user menu in the upper right corner of the page
...
def test_performance_color_key(tutor_base_url, selenium, student):
	...
	# THEN: The performance color key is presented (next to the 'Return to Dashboard' button)
...
@test_case('')
@accounts
def test_performance_forcast_with_zero_question(tutor_base_url, selenium, student):
	...
	# THEN: Presented with blank performance forecast with no section breakdowns and the 
	# words "User haven't worked enough problems for Tutor to predict User's weakest topics."
...
def test_performance_forcast_weak_area(tutor_base_url, selenium, student):
	...
	# THEN: The user is presented with up to four problematic sections under My Weaker Areas


@test_case('')
@accounts
def test_performance_forcast_individual_section(tutor_base_url, selenium, student):
	...
	# THEN: User is presented with chapters listed on top and their sections below
...
def test_performance_forcast_chapter(tutor_base_url, selenium, student):
	...
	# THEN: Page with up to five practice assessments for that chapter is loaded
...
def test_performance_forcast_section_bar(tutor_base_url, selenium, student):
	...
	# THEN: User is presented with up to five practice assessments for that section
...
def test_performance_forcast_without_data(tutor_base_url, selenium, student):
	...
	# THEN: User is presented with the "Practice More To Get Forecast" button under a 
	# section without enough data instead of a color bar


@test_case('')
@accounts
def test_performance_forcast_finished_assignment(tutor_base_url, selenium, student):
	...
	# WHEN: Once an assignment is completed, the user clicks the Performance Forecast
...
def test_payment_option(tutor_base_url, selenium, student):
	...
	# THEN: Payment screen -- with options for Free Trial and to Buy Access to course now is loaded
...
def test_course_payment(tutor_base_url, selenium, student):
	...
	# THEN: Student gets confirmation that payment was accepted successfully, and there should 
	# be an option to "Access User's Course"
...
def test_invalid__card_payment(tutor_base_url, selenium, student):
	...
	# THEN: Warning with "Invalid card number. Please check User's number and try again." is loaded
...
def test_trial_course_access(tutor_base_url, selenium, student):
	...
	# WHEN: The user navigates to a course while the 14 day grace period is still in effect
...
def test_teacher_dashboard(tutor_base_url, selenium, teacher):
	...
	# THEN: On the dashboard can see their all existing course's card with information
...
def test_roster_period_page(tutor_base_url, selenium, teacher):
	...
	# THEN:  Page with period with at least 3 students per section  is loaded
...
def test_preview_calendar(tutor_base_url, selenium, teacher):
	...
	# THEN: From the calendar, the user should be able see sample assignments and readings 
...
def test_add_reading(tutor_base_url, selenium, teacher):
	...
	# THEN: Dashboard of that course is successfully loaded and the reading assignment is visible on the calendar
...
def test_adding_reading_draft(tutor_base_url, selenium, teacher):
	...
	# THEN: Dashboard of that course is successfully loaded 	# AND the reading assignment draft is visible on the calendar

@test_case('')
@accounts
def test_edit_published reading(tutor_base_url, selenium, teacher):
	...
	# THEN: Dashboard of that course is successfully loaded and the reading assignment 
	# with edits is visible on the calendar
...
def test_add_homework_draft(tutor_base_url, selenium, teacher):
	...
	# WHEN: The user clicks on a date on the dashboard, then click "Add Homework"
